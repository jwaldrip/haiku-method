...
Anti-rationalization tables, red flags, and deviation rules (auto-fix vs pause-for-humans, node repair operator) are in the companion reference file.

**Read `hats/builder-reference.md` when:**
- You're tempted to skip a step (check anti-rationalization table)
- You encounter an unexpected issue (check deviation rules)
- You're unsure whether to auto-fix or pause (check pause-for-humans triggers)
