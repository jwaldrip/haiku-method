...
- [ ] H·AI·K·U plugin installed (`/plugin marketplace add TheBushidoCollective/haiku-method` then `/plugin install haiku@TheBushidoCollective-haiku-method --scope project`)
