...
|---|---|
| **Software** | Feature intent, user stories, acceptance criteria, unit breakdown with dependency graph |
| **Marketing** | Campaign brief, target audience definition, channel strategy, deliverable list with success metrics |
| **Operations** | Migration plan, risk assessment, rollback criteria, phased implementation checklist |
| **Research** | Research question, methodology selection, data source identification, analysis framework |
