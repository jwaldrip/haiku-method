						...
						<div className="rounded-xl border border-stone-200 bg-white p-6 dark:border-stone-800 dark:bg-stone-950">
							...
							<div className="space-y-3">
								...
								<div className="flex items-start gap-3">
									...
									<div>
										<div className="font-medium text-stone-900 dark:text-stone-100">Execute</div>
										<p className="text-sm text-stone-600 dark:text-stone-400">Agent runs the hat sequence, producing stage-specific deliverables.</p>
									</div>
								</div>
								<div className="flex items-start gap-3">
